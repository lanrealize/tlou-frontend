...
Component({
  ...
  methods: {
    ...
    // post-card事件处理
    onPostCardLike(e) {
      this.triggerEvent('postCardLike', e.detail);
    },

    onPostCardComment(e) {
      this.triggerEvent('postCardComment', e.detail);
    },

    onPostCardPreviewImage(e) {
      this.triggerEvent('postCardPreviewImage', e.detail);
    },

    onPostCardTapAvatar(e) {
      this.triggerEvent('postCardTapAvatar', e.detail);
    },

    onPostCardDelete(e) {
      this.triggerEvent('postCardDelete', e.detail);
    }
  }
})
